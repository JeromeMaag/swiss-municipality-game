...
Find the Municipality! needs municipality boundaries and population values
before a real game can be played.
...
only meant for checking that the game flow works.
